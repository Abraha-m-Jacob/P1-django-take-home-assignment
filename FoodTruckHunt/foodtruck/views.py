...
from .utils import (validate_required_fields, CustomValidationException, validate_latitude, validate_longitude,
                    find_distance_from_location, validate_pagination_params)
...
class FindFoodTruck(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            food_trucks = [food_truck for food_truck, distance in food_trucks_with_distance]
            ...
            logger.info("Completed request for finding closest food trucks successfully")
